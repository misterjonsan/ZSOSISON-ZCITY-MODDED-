...
local CategoresAllowed = {
    ...
    ["HG Ammo"] = true,
    ["HG Armor"] = true,
    ["HG Attachments Grips"] = true,
    ["HG Attachments Magwells"] = true,
    ["HG Attachments Muzzles"] = true,
    ["HG Attachments Sights"] = true,
    ["HG Attachments Underbarrel"] = true,
    ["Other"] = true,
}
...
function SWEP:CreateMenu()
    ...
    local xPos = ScrW() - 1900 - 10  
    local yPos = 610                 
    self.menu:SetPos(xPos, yPos)
    self.menu:Center()
