...
if CLIENT then
	...
	net.Receive("hg_phrase", function(len, ply)
		...
		if wawer then
			ent:EmitSound(phrase, wawer and 65 or muffed and 65 or 75,ply.VoicePitch or 100,1,CHAN_AUTO,0, muffed and 16 or 0)
			ent:EmitSound(phrase, wawer and 65 or muffed and 65 or 75,ply.VoicePitch or 100,1,CHAN_AUTO,0, muffed and 16 or 0)
		else
			ent:EmitSound(phrase, muffed and 65 or 75,ply.VoicePitch or 100,1,CHAN_AUTO,0, pitch and 56 or muffed and 16 or 0)
		end
