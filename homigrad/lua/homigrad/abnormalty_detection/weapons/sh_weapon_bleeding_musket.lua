-- "addons\\homigrad\\lua\\homigrad\\abnormalty_detection\\weapons\\sh_weapon_bleeding_musket.lua"
...
SWEP.WepSelectIcon2 = Material("deathnotify/death_brownbess")
SWEP.WepSelectIcon2box = true
SWEP.IconOverride = "deathnotify/death_brownbess"
SWEP.weight = 3
