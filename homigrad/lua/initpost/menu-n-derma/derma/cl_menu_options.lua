...
hg.settings:AddOpt("View","hg_realismcam", "Realistic Cam")
hg.settings:AddOpt("View","hg_nofovzoom", "No fov zoom")
hg.settings:AddOpt("View","hg_norenderoverride", "Disable renderoveride hook")
 
hg.settings:AddOpt("Sound","hg_dmusic", "Dynamic music")
hg.settings:AddOpt("Sound","hg_newsounds", "New sounds")
hg.settings:AddOpt("Sound","hg_auto_dsp", "Auto D.S.P.")
...
function PANEL:Init()
    ...
    self:SetColorBG( Color(255, 255, 255,120) )
    ...
    self:CreateCategory( "ZSosison Settings" )
...
local color_reddy = Color(77, 0, 0)
local color_whatiy = Color(255, 255, 255)
local color_cherny = Color(0, 0, 0)
...
function PANEL:CreateOption( strCategory, bType, cConVar, bDecimals, strTitle, strDesc, bString )
    ...
    function opt:Paint(w,h)
        ...
        surface.SetDrawColor( color_whatiy )
    ...
    elseif bType then
        ...
        function btn:Paint(w,h)
            ...
            local CLR = color_reddy:Lerp(Color(13, 94, 0),self.Lerp)
